...
namespace FragrantWorld.Pages
{
    ...
    public partial class ShopPage : Page
    {
        ...
        private void ApplyFilters()
        {
            ...
            if (ManufacturerComboBox.SelectedIndex > 0) // Первый элемент "Все производители"
            {
        ...
        {
            string countDisplay = $"{_filteredProducts.Count} из {_allProducts.Count}";
            ProductCountDisplay.Text = countDisplay;
        }
